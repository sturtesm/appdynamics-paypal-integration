...
#Enable AppDynamics Monitoring for this Instance
JAVA_OPTS="$JAVA_OPTS -javaagent:/Users/steve.sturtevant/Tools/AppDynamics/AppDynamicsProAgent/javaagent.jar"
JAVA_OPTS="$JAVA_OPTS -Dappdynamics.agent.applicationName=PaymentServicesWebTier -Dappdynamics.agent.tierName=WebTier -Dappdynamics.agent.nodeName=apache-tomee-jaxrs-1.6.0"
